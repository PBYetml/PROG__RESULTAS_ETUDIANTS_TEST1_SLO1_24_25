...
void DatasCutting(int frame)
{
	...
	puissance = frame >> 8;		// puissance prend la valeur des 8 bits après les 8 premiers bits de frame
	courant = frame >> 16;		// courant prend la valeur des 8 bits après les 16 premiers bits de frame
	tension = frame >> 24;		// tension prend la valeur des 8 bits après les 24 premiers bits de frame
