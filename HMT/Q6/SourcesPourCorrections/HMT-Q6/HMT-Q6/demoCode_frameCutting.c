...
{
	//-- Define declarations --//
#define NIBBLE4 0xFF000000	// adress or storage slot 32bit
#define NIBBLE3 0x00FF0000	// adress or storage slot 32bit
#define NIBBLE2 0x0000FF00	// adress or storage slot 32bit
#define NIBBLE1 0x000000FF	// adress or storage slot 32bit
// 
//-- variable declarations --//
